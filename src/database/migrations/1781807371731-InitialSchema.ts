...
export class InitialSchema1781807371731 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "UQ_employee_current_salary" ON "salaries"  ("employee_id") WHERE is_current = true`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_7147253b7b7085f033753d4f4e" ON "salaries"  ("employee_id", "is_current") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_dab273bfeb6e0fbd0f228f4660" ON "salary_history"  ("employee_id", "changed_at") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "salary_history" ADD CONSTRAINT "FK_c70621f2e600c3f966898714db3" FOREIGN KEY ("employee_id") REFERENCES "employees"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "salary_history" DROP CONSTRAINT "FK_c70621f2e600c3f966898714db3"`,
    );
    await queryRunner.query(
